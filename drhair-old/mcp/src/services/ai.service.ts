...
export class AIService {
  ...
  private static providerConfigs: Record<AIProvider, ProviderConfig> = {
    openai: {
  ...
  constructor(config?: Partial<AIConfig>) {
    this.provider = (config?.provider || process.env.AI_PROVIDER || 'anthropic') as AIProvider;
  ...
  static createForTenant(agentConfig?: {
    ...
    const provider = agentConfig.ai_provider as AIProvider;
