    ...
    switch (name) {
      ...
      case "salvar_memoria": {
        ...
        const memoryData = {
          tenant_id: tenantId,
          lead_id: leadId,
          type: ({'fato':'fact','contexto':'semantic','preferencia':'preference','objecao':'objection','compromisso':'commitment','episodico':'episodic'}[(args.tipo as string)?.toLowerCase()] || (args.tipo as string) || 'fact'),
